...
public class roadMap : ScriptableObject {
    ...
    public List<string>[] workerTalk = new List<string>[6];
    public void InitializeWorkerTalk(){
        workerTalk[0] = new List<string>{
            // Dia 1
            ...
            // Dia 2: o jogo assume seu ritmo normal e as escolhas noturnas são desbloqueadas.
            ...
            // Dia 12: Alguns trabalhadores parecem doentes. Esse dia serve como uma introdução às condições ruins de saúde.
            ...
            // Dia 20: Um novo grupo de trabalhadores chega, demonstrando a constante circulação de novos trabalhadores para substituir os antigos.
            ...
            // Dia 22: Nesse dia o Trabalhador 1 foge floresta adentro, tentando voltar para sua casa.
        ...
        workerTalk[4] = new List<string>{
            // Dia 25: Ocorre um deslizamento durante a noite anterior,
            ...
            // Dia 26: O conserto dos trilhos é finalizado neste dia,
            ...
            // Dia 27: Os sintomas do jogador pioram, tornando o trabalho ainda mais difícil.
